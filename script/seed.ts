...
const seed = async () => {
  ...
  try {
    ...
    const etapes = [
      [
        1,
        "Tu ouvres les yeux, étendu sur un sol froid et dur. Autour de toi, des ruines noyées dans une brume cramoisie. L'air sent la chair calcinée et la cendre mouillée. Le ciel est figé, crevé d'un œil rouge qui ne cligne jamais. Tu n'as ni souvenir, ni nom. Juste la sensation aiguë que tu n'es pas censé être là… pas en vie. Tu te redresses lentement. Tes membres sont engourdis, ta gorge sèche comme si tu avais crié des siècles dans le vide. Tu baisses les yeux sur ta main droite : une marque noire, brûlée dans ta chair. Un œil fermé, entouré de crocs. Tu n'en connais pas le sens, mais il pulse, chaud, comme un cœur battant. Quelque chose en toi sait : cette marque est une clef. Ou une malédiction. Derrière toi, un craquement. Tu te retournes d'instinct. Une silhouette approche entre les pierres effondrées : une vieille femme drapée d'un manteau de suie. Son visage est masqué par un bandeau de cuir clouté. « Tu n'as pas de nom… » dit - elle d'une voix rauque. « Alors tu peux en forger un. Mais la Marque… elle, t'a choisi. » Elle tend la main. Tu hésites… puis la prends. « Suis - moi, Porte - Marque. Il te reste peu de temps avant que le Néant ne te réclame de nouveau. »",
        1,
