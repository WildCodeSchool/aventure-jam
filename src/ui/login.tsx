...
export default function SignInPage() {
  ...
  if (session) {
    return (
      <div>
        <button onClick={() => signOut()} className={styles.deconnectionButton}>
          <img src="/Logo/logOut.svg" alt="log out"></img>
        </button>
        <img
          src="https://img.freepik.com/premium-vector/dark-fantasy-portrait-witch-illustration_961307-7342.jpg"
  ...
  return (
    <div>
      <button className={styles.gsiMaterialButton} onClick={handleConnection}>
        ...
        <div className={styles.gsiMaterialButtonContentWrapper}>
          ...
          <span className={styles.gsiMaterialButtonContents}>Sign in</span>
        </div>
      </button>
    </div>
  );
